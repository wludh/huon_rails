...
library_id = '469500' # your group or user ID (e.g., six numeric digits)
...
jquery_path = "/js/vendor/jquery.js"  # path to jquery file on the server
...
if write_full_html_header:
    ...
    html_footer += u'</div>'
    html_header += '<header class="row"><div class="large-12 columns text-center"><h1>'+'Bibliography'+"</h1></div></header>\n";
